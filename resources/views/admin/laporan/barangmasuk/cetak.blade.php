                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <tr>
                                <td align="center">
                                    <span style="line-height: 1.6; font-weight: bold;">
                                        KING GROUP
                                        <br>Jl. Ir. H. Juanda No.90, Air Putih, Kec. Samarinda Ulu, Kota Samarinda, Kalimantan Timur
                                        <br>No Telp
                                    </span>
                                </td>
                            </tr>
                        ...
                        <table class="table table-bordered">
                            ...
                            @if($total_barang_masuk)
    
                            <tr>
                                <th colspan="6">Seluruh Total</th>
                                <th>Rp. {{ number_format($total_barang_masuk) }}</th>
                            </tr>
