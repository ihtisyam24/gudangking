                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ $no_transaksi_keluar }}" name="no_transaksi_keluar" readonly required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Total</label>
                                        <input type="text" class="form-control" placeholder="Total ..." id="total_keluar" name="total_keluar" readonly required>
                                    </div>
                                    <div class="form-group">

                                    <select class="form-control">
                                        @foreach ($data_outlets as $data_outlet)
                                            
                                       
                                        <option selected>Pilih Outlet</option>
                                        <option value="{{ $data_outlet->id }}">{{ $data_outlet->nama }}</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#harga, #qty_keluar").keyup(function() {
            var harga      = $("#harga").val();
            var qty_keluar = $("#qty_keluar").val();

            var total_keluar = parseInt(harga) * parseInt(qty_keluar);
